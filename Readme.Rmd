...
KOIOS is a tool that is used to generate a set of OMOP Concept IDs, and related information, from a given VCF file, utilizing resources provided by ClinVar.
...
Users may simply replace the relevant information in the userScript.R file, or may utilize the package according to the following workflow:
